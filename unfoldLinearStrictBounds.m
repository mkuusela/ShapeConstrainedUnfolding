...
load(['./data/linearData_lumFactor',num2str(lumFactor),'nBinsE',num2str(nBinsE),'nBinsF',num2str(nBinsF),'.mat']);
...
save(['./results/linearStrictBoundsUnfolded_lumFactor',num2str(lumFactor),'binMultiplier',num2str(binMultiplier),'MPos',num2str(MPos),'MMon',num2str(MMon),'MCon',num2str(MCon),'nBinsE',num2str(nBinsE),'nBinsF',num2str(nBinsF),'alpha',num2str(alpha),'.mat'],'lbHPosUc','lbHPosOc','lbHMonUc','lbHMonOc','lbHConUc','lbHConOc','ubHPosUc','ubHPosOc','ubHMonUc','ubHMonOc','ubHConUc','ubHConOc','optNuTildeLbPosUc','optNuTildeLbPosOc','optNuTildeLbMonUc','optNuTildeLbMonOc','optNuTildeLbConUc','optNuTildeLbConOc','optNuTildeUbPosUc','optNuTildeUbPosOc','optNuTildeUbMonUc','optNuTildeUbMonOc','optNuTildeUbConUc','optNuTildeUbConOc');
