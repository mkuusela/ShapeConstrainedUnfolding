...
save(['./results/linearStrictBoundsCoverage_lumFactor',num2str(lumFactor),'binMultiplier',num2str(binMultiplier),'nSamples',num2str(nSamples),'nBinsE',num2str(nBinsE),'nBinsF',num2str(nBinsF),'alpha',num2str(alpha),'.mat'],'coverageBinWisePos','coverageJointPos','coverageBinWiseMon','coverageJointMon','coverageBinWiseCon','coverageJointCon','lbHPosUc','lbHPosOc','lbHMonUc','lbHMonOc','lbHConUc','lbHConOc','ubHPosUc','ubHPosOc','ubHMonUc','ubHMonOc','ubHConUc','ubHConOc');
